...
colors and icons. Download the [zip file for the latest release](https://github.com/pxtools/PxWeb3/releases/latest) from GitHub. This guide help you customize PxWeb to your needs.
